    ...
    <div className="space-y-6">
      ...
      {postToReport && (
        <ReportPostModal
          ...
          postOwnerName={postToReport.createdBy?.name || "Unknown User"}
          postContentPreview={
            postToReport.description.length > 50
              ? postToReport.description.substring(0, 50) + "..."
              : postToReport.description
          }
        />
      )}
    </div>
